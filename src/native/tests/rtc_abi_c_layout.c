...
_Static_assert(sizeof(gb_rtc_network_config) == 64, "network config layout");
_Static_assert(offsetof(gb_rtc_network_config, external_ipv4) == 24, "network address offset");
_Static_assert(offsetof(gb_rtc_network_config, reserved) == 32, "network reserved offset");
